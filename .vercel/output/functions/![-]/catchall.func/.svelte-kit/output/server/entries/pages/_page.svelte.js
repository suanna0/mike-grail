...
function Gallery($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="gallery-container svelte-1oz3msq"><div class="image-columns svelte-1oz3msq"><div class="thumbnail-column svelte-1oz3msq"><!--[-->`);
    const each_array = ensure_array_like(galleryItems.filter((_, i) => i % 2 === 0));
    ...
    const each_array_3 = ensure_array_like(galleryItems.filter((_, i) => i % 2 === 1));
    for (let $$index_5 = 0, $$length = each_array_3.length; $$index_5 < $$length; $$index_5++) {
      let item = each_array_3[$$index_5];
      $$renderer2.push(`<div class="gallery-item svelte-1oz3msq" role="button" tabindex="0"><div class="image-container svelte-1oz3msq"><!--[-->`);
      ...
      $$renderer2.push(`<!--]--></div> <div class="mobile-description svelte-1oz3msq"><!--[-->`);
      const each_array_5 = ensure_array_like(formatDescription(item.description));
      for (let index = 0, $$length2 = each_array_5.length; index < $$length2; index++) {
        let part = each_array_5[index];
        if (part.isTitle) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<h2>${escape_html(part.text)}</h2>`);
        } else {
    ...
    $$renderer2.push(`<!--]--></div></div> <div class="description-column svelte-1oz3msq"><div class="description-content svelte-1oz3msq">`);
    {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<p class="description-text placeholder svelte-1oz3msq">Hover on images</p>`);
    }
