...
function Nav($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      })}><h2>${escape_html(item.label)}</h2></button>`);
    }
...
function Footer($$renderer, $$props) {
  const title = "Footer";
  $$renderer.push(`<footer class="svelte-jz8lnl"><button class="button svelte-jz8lnl"><a target="_blank" href="https://suannazhong.com">Suanna Zhong</a>, 2026</button> <button class="button svelte-jz8lnl">Back to Top ↑</button></footer>`);
